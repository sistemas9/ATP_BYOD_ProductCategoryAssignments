...
{
    class DatabaseSolarisProductivo
    {
        IDataReader rd = null;
        int rowsAfected = 0;
        public SqlConnection conn;

        public DatabaseSolarisProductivo()
        {
            ...
            conectionString = AppSettings["DB_SVR10_EXTERNO"];
            if ( AppSettings["Config"] == "DESARROLLO" || AppSettings["Config"] == "PRODUCCIONLOCAL")
            {
              conectionString = AppSettings["DB_SVR10_INTERNO"];
            }
